 ...
 *      Author: mayotte
 */
void PlotFDdistanceEye4Electron(){ //run via root Plot.C
...
Mean1->Draw("sames");
  ...
  Canvas1->Print("RFDElectronE17_17.5Theta115_120.pdf"); //This saves the plot 
  ...
  Canvas2->Print("RFDElectronE17.5_18Theta115_120.pdf"); //This saves the plot 
  ...
  Canvas3->Print("RFDElectronE18_18.5Theta115_120.pdf"); //This saves the plot 
