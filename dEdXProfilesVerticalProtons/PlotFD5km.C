 ...
 *      Author: mayotte
 */
void PlotFD5km(){ //run via root Plot.C
  ...
  */
  ...
  TFile *AnalysisFile1 = new TFile("./AnalysisOutHeight1.4FD5km22bins.root","READ");//reading in your root file with histograms
  TFile *AnalysisFile2 = new TFile("./AnalysisOutHeight2FD5km22bins.root","READ");//reading in your root file with histograms
  TFile *AnalysisFile3 = new TFile("./AnalysisOutHeight3FD5km22bins.root","READ");//reading in your root file with histograms
  ...
  Axis1->GetXaxis()->SetTitleSize(.065);//changes the axis title size
 ...
 // Mean1->Rebin(12);
  ...
  leg = new TLegend(.7,0.7,.96,0.93); //size of legend
  ...
  Canvas1->Print("Chi1RFD5.pdf"); //This saves the plot to Mean.pdf
