 ...
 *      Author: mayotte
 */
void PlotFD10km(){ //run via root Plot.C
  ...
  */
  ...
  TFile *AnalysisFile1 = new TFile("./AnalysisOutHeight1.4FD10km22bins.root","READ");//reading in your root file with histograms
  TFile *AnalysisFile2 = new TFile("./AnalysisOutHeight2FD10km22bins.root","READ");//reading in your root file with histograms
  TFile *AnalysisFile3 = new TFile("./AnalysisOutHeight3FD10km22bins.root","READ");//reading in your root file with histograms
  TFile *AnalysisFile4 = new TFile("./AnalysisOutHeight5FD10km22bins.root","READ");
 ...
 //Mean3->Rebin(22);
  ...
  leg = new TLegend(.57,0.7,.96,0.93); //size of legend
  ...
  Canvas1->Print("Chi1RFD10.pdf"); //This saves the plot to Mean.pdf
